...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.10                                                                             #
# Filename   : /aimobile/service/review.py                                                         #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# Modified   : Thursday April 20th 2023 07:04:38 am                                                #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
from aimobile.data.x_appstore.http.review import AppStoreReviewRequest
from service.factory import AbstractReviewScraper
