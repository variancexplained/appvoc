...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.10                                                                             #
# Filename   : /tests/test_database/test_database.py                                               #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# Modified   : Saturday April 8th 2023 03:08:29 am                                                 #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
single_line = f"\n{100 * '-'}"
# ------------------------------------------------------------------------------------------------ #
DBFILEPATH = "sqlite:///tests/data/test.db"
...
class TestDatabase:  # pragma: no cover
    ...
    def test_query(self, caplog):
        ...
        logger.info(double_line)
        # ---------------------------------------------------------------------------------------- #
        QUERY = "SELECT * FROM iris WHERE Name = ?;"
        PARAMS = ("Iris-virginica",)
