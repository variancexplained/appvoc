...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.10                                                                             #
# Filename   : /aimobile/service/appdata.py                                                        #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# Modified   : Thursday April 20th 2023 07:05:20 am                                                #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
from aimobile.data.x_appstore.http.appdata import AppStoreSearchRequest
from service.factory import AbstractAppDataScraper
