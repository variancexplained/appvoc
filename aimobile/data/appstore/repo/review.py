...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.10                                                                             #
# Filename   : /aimobile/data/appstore/repo/review.py                                              #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
from aimobile.data.appstore.repo.base import Repo
from aimobile.framework.database.mysql import MySQLDatabase
from aimobile.data.appstore.entity.review import AppStoreReview
