...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.10                                                                             #
# Filename   : /aimobile/data/appstore/service/rating.py                                           #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# Modified   : Tuesday April 18th 2023 11:15:01 am                                                 #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
from aimobile.data.appstore.http.rating import AppStoreRatingRequest
from aimobile.data.base import AbstractRatingScraper
