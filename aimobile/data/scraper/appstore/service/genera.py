...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.10                                                                             #
# Filename   : /aimobile/data/scraper/appstore/service/genera.py                                   #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# Modified   : Tuesday April 4th 2023 06:13:07 pm                                                  #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
    ...
    def get_entries(self, clazz_name):
        ...
        for collection in dir(clazz_name):
            if not collection.startswith("__"):
                method_names[str(collection.replace("_", " "))] = getattr(
                    clazz_name, str(collection)
                )
