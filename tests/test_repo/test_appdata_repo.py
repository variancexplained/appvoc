...
# Modified   : Friday April 28th 2023 10:51:18 pm                                                  #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
from aimobile.data.repo.appstore import AppStoreAppDataRepo
...
class TestAppStoreAppDataRepo:  # pragma: no cover
    ...
    def test_update(self, appstore_appdata_repo, caplog):
        ...
        df = repo.get(id=ID)
        logger.debug(f"\nTest Update Result:\n{df}")
        assert df["rating"][0] == VALUES[0]
        assert df["source"][0] == VALUES[1]
