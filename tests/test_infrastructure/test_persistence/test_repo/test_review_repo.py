...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.10                                                                             #
# Filename   : /tests/test_infrastructure/test_persistence/test_repo/test_review_repo.py           #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# Modified   : Friday April 28th 2023 12:45:36 pm                                                  #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
from aimobile.infrastructure.repo.appstore import AppStoreReviewRepo
...
class TestReviewRepo:  # pragma: no cover
    ...
    def test_add(self, container, review, caplog):
        ...
        with container.data.db() as db:
            repo = AppStoreReviewRepo(database=db)
            repo.replace(data=review)
