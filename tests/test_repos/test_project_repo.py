...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.10                                                                             #
# Filename   : /tests/test_repos/test_project_repo.py                                              #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# Modified   : Saturday April 8th 2023 12:10:59 am                                                 #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
class TestProjectRepo:  # pragma: no cover
    ...
    def _check_project(self, project: AppStoreProject):
        ...
        assert isinstance(project.term, str)
        assert isinstance(project.page_limit, int)
        assert isinstance(project.max_pages, int)
        assert isinstance(project.app_count, int)
        assert isinstance(project.page_count, int)
        assert isinstance(project.country, str)
        assert isinstance(project.lang, str)
        assert isinstance(project.timeout, int)
        assert isinstance(project.delay, int)
        assert isinstance(project.sessions, int)
    ...
    def test_add_rollback(self, project, container, caplog):
        ...
        # ---------------------------------------------------------------------------------------- #
        # Start transaction
        dc = container.datacentre.appstore()
        dc.begin()
