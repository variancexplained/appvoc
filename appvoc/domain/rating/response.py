...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.11                                                                             #
# Filename   : /appvoc/domain/rating/response.py                                                   #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# Modified   : Saturday June 29th 2024 11:52:24 pm                                                 #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
class RatingResponse(Response):
    """Encapsulates the rating response.

    Inherits the following from Response base class:
    ...
    def add_response(self, response: dict, batch: dict) -> None:
        ...
        Args:
           response (dict): Dictionary containing review response data
        """
