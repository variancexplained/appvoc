...
# Version    : 0.1.19                                                                              #
# Python     : 3.10.12                                                                             #
# Filename   : /appvoc/infrastructure/file/archive.py                                            #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
from appvoc.infrastructure.file.base import Archiver
...
class FileArchiver(Archiver):
    ...
    def archive(self) -> str:
        ...
        try:
            ...
            archive_filepath = os.path.join(
                self._archive_folder, os.path.basename(filepath)
            )
    ...
    def _get_archive_filename(self) -> str:
        filename = "appvoc_" + datetime.now().strftime("%Y-%m-%d_T%H%M%S") + ".tar.gz"
